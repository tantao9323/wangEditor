...
var config = {
    ...
    // 默认菜单配置
    menus: ['head', 'bold', 'fontSize', 'fontName', 'italic', 'underline', 'strikeThrough', 'horizontalRule', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo'],
            ...
            tabs: [{
                ...
                // 插入链接
                {
                    ...
                    fn: function fn() {
                        ...
                        var link = $link.val();
                        var text = $text.val();
                        return _this._insertLink(text, link);
...
Image.prototype = {
    ...
    _createEditPanel: function _createEditPanel() {
        ...
        var tabsConfig = [{
            title: '编辑图片',
            tpl: '<div>\n                    <div class="w-e-button-container" style="border-bottom:1px solid #f1f1f1;padding-bottom:5px;margin-bottom:5px;">\n                        <input type="range" id="input-sidler" min="0" max="100" value="100"/>\n                    </div>\n                    <div class="w-e-button-container">\n                        <button id="' + delBtn + '" class="gray left">\u5220\u9664\u56FE\u7247</button>\n                    </dv>\n                </div>',
            events: [{
                selector: '#input-sidler',
                type: 'input propertychange',
                fn: function fn(v) {
                    var $img = editor._selectedImg;
                    if ($img) {
                        $img.css('max-width', document.getElementById('input-sidler').value + '%');
                    }
                    return false;
                    // 返回 true，表示该事件执行完之后，panel 要关闭。否则 panel 不会关闭
                    // return true
...
Command.prototype = {
    ...
    _insertHorizontalRule: function _insertHorizontalRule() {
